...
Get [latest Release](https://github.com/Old-iddi/KeySay/releases) - it is signed and notarised.

Also available on [Mac App Store, get it there](https://apps.apple.com/ru/app/keysay-key-clicker-and-more/id6802026223). App Store version will automatically follow updates so you don't need to look for new releases here.
